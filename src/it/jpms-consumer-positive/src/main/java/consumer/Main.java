 ...
 * {@code requires dev.jcputney.magika;}, (b) Magika / MagikaResult / Status are reachable from
 * the public API package, (c) runtime exercise of identifyBytes works (also verifies Pitfall 5 —
 * {@code requires com.microsoft.onnxruntime} in the magika module is correct because identifyBytes
 * will trigger ORT load).
 */
public class Main {
