...
/**
 * Result of a Magika identify call — matches upstream Python shape (API-05). Field names are
 * {@code dl} / {@code output} / {@code score} exactly as Python's {@code MagikaResult}; do not
 * camel-case or rename.
 *
 ...
 */
public record MagikaResult(MagikaPrediction dl, MagikaPrediction output, double score) {
