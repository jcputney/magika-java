 ...
 *
 * <p>Per CLAUDE.md package-isolation rules: this class lives in {@code postprocess}, depends only
 * on {@link ThresholdConfig} (config — read-only consumer) and {@link PredictionMode} (postprocess —
 * same package). Zero ONNX, zero Jackson.
 */
